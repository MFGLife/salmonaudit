...
const swiper = new Swiper(".mySwiper", {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      "descriptionList": [
      { "text": "Carolyn Salmon, Chanille Witham", "status": "completed" },
      { "text": "Kelly Truelove, Jozef Hanratty", "status": "completed" },
      { "text": "Josh Garrett, Crycella Freitag", "status": "completed" },
      { "text": "Mark Stephenson, Matt Selby", "status": "completed" },
      { "text": "Christian Freitag, Amanda Freitag", "status": "completed" },
      { "text": "Tyler Brown, Stephanie Reed", "status": "completed" },
      { "text": "Natasha Kluttz, Trina Nudson", "status": "completed" },
